...
<link rel="stylesheet" href="${request.contextPath}/statics/css/app.css">
<link rel="stylesheet" href="${request.contextPath}/statics/css/theme.css">
<link rel="stylesheet" href="${request.contextPath}/statics/css/main.css">
<link rel="stylesheet" href="${request.contextPath}/statics/css/my.css">
...
<script>
	if (typeof window.xh !== "object") {
		window.xh = {};
	}
	xh.base = "${request.contextPath}";
	/**
	 * F5 仅刷新 iframe 内容
	 * @param e
	 */
...
<script src="${request.contextPath}/statics/js/component/xh-http.js"></script>
<script>
	xh.http.setAjaxToken();
</script>
<#include "component/xh-select.ftl">